 ...
 */
final class Version20250130182910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id SERIAL NOT NULL, theme_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, is_private BOOLEAN NOT NULL, max_capacity INT NOT NULL, start_time TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, end_time TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, invite_code VARCHAR(32) NOT NULL, is_started BOOLEAN NOT NULL, PRIMARY KEY(id))');
